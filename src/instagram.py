...
## 캡션 규칙 (v1.2 — 2026 IG 알고리즘 최적화)
- 본문 400~700자 (dwell time / save 신호 강화)
- 첫 줄 = 후크 한 문장 (스크롤 멈춤 유도)
- 줄바꿈 충분히 활용 (3~5줄 단위로 끊기)
- 마지막 줄 = "전체 가이드는 블로그에서 보세요 ↓" + 프로필 링크 안내
- 해시태그 5~7개 (niche 위주, 광범위 1~2개만)
- 이모지 절대 사용 금지
