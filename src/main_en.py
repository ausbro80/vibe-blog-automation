...
v1.1 Fix:
  ...
  - Markdown cleanup post-processing added
"""
...
def clean_markdown(html: str) -> str:
    """Convert leftover markdown syntax to HTML tags"""
...
"""
    ...
    # Step 2: HTML body as plain text
...
- NEVER use markdown syntax (**bold**, *italic*, ## headings) — use HTML tags only
- For bold text use <strong> tags, not **asterisks**
- For line breaks use <br> or <p> tags
